...
import portfolioBilde from "../assets/portfolioBilde.png";
...
const Hero = () => {
    return (
        <div className="flex justify-center"> 
            <div className="bg-gradient-to-tl from-zinc-950 via-zinc-800 to-zinc-950 h-full w-screen">   
                ...
                <div className="flex justify-center flex-col text-center ">
                    ...
                    <p className="w-64 text-white font-mono">There are 10 types of people, those who understand binary and those who dont. <br></br>-Rias's teacher</p>
                ...
                <div className="flex justify-center">
                    <div className="flex justify-around w-80 mb-4">
                        ...
                        <div className="p-3 border rounded">
                        <MdCss size={48} className="text-white hover:text-blue-500" />                    </div>
                        <div className="p-3 border rounded">
                ...
                <div className="flex flex-col items-center">
                    <h1 className="text-white font-semibold text-center font-mono my-6">Past Projects</h1>
                    <div className="flex flex-col lg:flex-row lg:flex-wrap lg:justify-around my-4">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-white text-xxs font-mono text-center px-10">A simple booking website using a API to let registered users to post and book venues.</p>
                            <a className="flex justify-center text-white text-xxs border rounded my-2 w-1/4" href="https://github.com/Caplix/Final-exam-2024" target="_blank">Read more</a>
                        </div>
                        </div>
                        <div className="flex flex-col w-80 border rounded my-4 lg:my-0 lg:mx-2">
                        <div className="flex justify-center w-full my-2 mx-1">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <a className="flex justify-center text-white text-xxs border rounded my-2 w-1/4" href="https://github.com/Caplix/React-course-assignment" target="_blank">Read more</a>
                        </div>
                        </div>
                        <div className="flex flex-col w-80 border rounded my-4 lg:my-0 lg:mx-2">
                        <div className="flex justify-center w-full my-2 mx-1">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-white text-xxs font-mono text-center px-10">A auction website using a API to let registered users bid on and sell items.</p>
                            <a className="flex justify-center text-white text-xxs border rounded my-2 w-1/4" href="https://github.com/Caplix/semester-project-2" target="_blank">Read more</a>
                        </div>
                        </div>
